 ...
 *
 * - RKM10：1280×800（16:10，十寸）
 * - RKM13：1920×1080（16:9，十三寸）
 *
...
object ScreenSpec {
    ...
    /** 低于此逻辑宽度视为 RKM10 档布局（仅作兜底；优先用 [formFactor] 长短边判定） */
    val compactMaxWidthDp = 960.dp

    /** 短边 ≤820dp 且长边 ≤1320dp → RKM10（1280×800） */
