...
object ApkUpdateBrightnessCover {
    ...
    /** 与 netshield_install.sh 分离，避免互相干扰。 */
    private const val HOLD_SCRIPT = "/data/local/tmp/netshield_bl_hold.sh"
    private const val STOP_FLAG = "/data/local/tmp/netshield_bl_restore"
