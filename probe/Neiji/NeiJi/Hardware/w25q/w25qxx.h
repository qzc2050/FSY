...
/* Size of the flash */
#define QSPI_FLASH_SIZE            8     /* 地址总线宽度访问整个内存空间 */
#define QSPI_PAGE_SIZE             256      // 单位：字节
#define QSPI_SECTOR_SIZE           4096     // 单位：字节
#define QSPI_BLOCK_SIZE            64       // 单位：KB
