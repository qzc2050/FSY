...
#define SOFTWARE_VERSION   0x01180301    //例如：01170B17 --> 01代23年11月23日
...
#define GEIGER_TUBE_SENSITY            1.1   //盖革管灵敏度
...
//uint8_t uint_deal_CPM(char *str,float dose_rate);
uint8_t uint_deal(char *str,float dose_rate);
//void Ave_Data_deal(void);
...
//uint32_t Get_all_GM_cnt(uint32_t group);
