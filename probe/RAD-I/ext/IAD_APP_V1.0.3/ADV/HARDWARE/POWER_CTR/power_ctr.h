#ifndef __POWER_CTR_H
#define __POWER_CTR_H
...
//#define POWER_CTR_SCL_out(n)   HAL_GPIO_WritePin(GPIOB,GPIO_PIN_8,n)  //输出 
//#define POWER_CTR_SDA_out(n)   HAL_GPIO_WritePin(GPIOB,GPIO_PIN_9,n)  //输出 记得修改回来！！！！！！！！！！！！！！
//#define POWER_CTR_SDA_in()     HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_9) //输入 
...
_MAX17048_C_EXT_ uint16_t max17048_get_permille(void);
_MAX17048_C_EXT_ uint8_t max17048_get_millivolt(float *volt);
...
_MAX17048_C_EXT_ void MAX17048_Compensation(uint8_t RComp);
