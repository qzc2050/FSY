...
///////////////////// VARIABLES ////////////////////
lv_anim_t * rotation_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * iconon_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * sidebaron_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * opaon_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * opaoff_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * choosenext_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * entryalarmsetting_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * choosefirst_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * chooseprev_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * chooselast_Animation(lv_obj_t * TargetObject, int delay);
...
lv_anim_t * iconon_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_values(&PropertyAnimation_0, -256, 16);
    lv_anim_set_path_cb(&PropertyAnimation_0, lv_anim_path_linear);
    lv_anim_set_delay(&PropertyAnimation_0, delay + 0);
    lv_anim_set_deleted_cb(&PropertyAnimation_0, _ui_anim_callback_free_user_data);
    lv_anim_set_playback_time(&PropertyAnimation_0, 0);
...
lv_anim_t * choosenext_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_values(&PropertyAnimation_0, 0, 65);
    lv_anim_set_path_cb(&PropertyAnimation_0, lv_anim_path_linear);
    lv_anim_set_delay(&PropertyAnimation_0, delay + 0);
    lv_anim_set_deleted_cb(&PropertyAnimation_0, _ui_anim_callback_free_user_data);
    lv_anim_set_playback_time(&PropertyAnimation_0, 0);
...
lv_anim_t * entryalarmsetting_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_values(&PropertyAnimation_0, 0, 640);
    ...
    lv_anim_set_values(&PropertyAnimation_1, 0, 345);
    ...
    lv_anim_set_values(&PropertyAnimation_2, 0, 46);
...
lv_anim_t * chooselast_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_user_data(&PropertyAnimation_0, PropertyAnimation_0_user_data);
    lv_anim_set_custom_exec_cb(&PropertyAnimation_0, _ui_anim_callback_set_y);
    lv_anim_set_values(&PropertyAnimation_0, 360, 260);
    lv_anim_set_path_cb(&PropertyAnimation_0, lv_anim_path_linear);
    lv_anim_set_delay(&PropertyAnimation_0, delay + 0);
    lv_anim_set_deleted_cb(&PropertyAnimation_0, _ui_anim_callback_free_user_data);
    lv_anim_set_playback_time(&PropertyAnimation_0, 0);
...
void ui_event____initial_actions0(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_SCREEN_LOAD_START) {
        rotation_Animation(ui_radiation, 0);
    }
}
...
void ui_init(void)
{
    ...
    ui_Start_interface_screen_init();
    ui_Main_Interface_screen_init();
    ui____initial_actions0 = lv_obj_create(NULL);
    lv_obj_add_event_cb(ui____initial_actions0, ui_event____initial_actions0, LV_EVENT_ALL, NULL);

    lv_disp_load_scr(ui____initial_actions0);
    lv_disp_load_scr(ui_Main_Interface);
    
    static lv_group_t *g;	//󶨵豸
...
{
    ui_Start_interface_screen_destroy();
    ui_Main_Interface_screen_destroy();
}

void ui_relocalize(void)
{
    ui_Start_interface_screen_relocalize();
    ui_Main_Interface_screen_relocalize();
}
