...
/* 每行 24 个 PWM 比较值 = 1 颗 LED 的 24 bit；尾部若干行 CCR=0 为 RES */
...
void ws2812b_init(void)
{
  ...
  /* STM32H7：APB1 分频 ≠ 1 时，TIM4 内核时钟 = 2×PCLK1 */
  ...
  /* 位周期 1500 ns（T1H+T1L）；T0H=340ns、T1H=750ns -> CCR，T0L=1500−T0H */
...
//     {
//         dma_busy_flag = 0; // DMA传输完成
//     }
// }

/*
功能：显示颜色
参数：Pixel_Len :点亮个数  ，color :颜色 ，led_num :总数量 ，bright :亮度
*/
