...
//	fftemp = (FIL*)osRtxMemoryAlloc(MALLOC_AXISRAM, sizeof(FIL), 0);
//	if(fftemp==NULL)rval=1;

//	//tempbuf=mymalloc(SRAMIN,4096);				//分配4096个字节空间
//	tempbuf = osRtxMemoryAlloc(MALLOC_AXISRAM, 4096, 0);
...
//	osRtxMemoryFree(MALLOC_AXISRAM, fftemp);
//	osRtxMemoryFree(MALLOC_AXISRAM, tempbuf);
...
//	pname = osRtxMemoryAlloc(MALLOC_AXISRAM, 100, 0);
//	buf = osRtxMemoryAlloc(MALLOC_AXISRAM, 4096, 0);
//	fftemp = (FIL*)osRtxMemoryAlloc(MALLOC_AXISRAM, sizeof(FIL), 0);
...
//		osRtxMemoryFree(MALLOC_AXISRAM, fftemp);
//		osRtxMemoryFree(MALLOC_AXISRAM, pname);
//		osRtxMemoryFree(MALLOC_AXISRAM, buf);
