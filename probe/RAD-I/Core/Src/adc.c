...
/* USER CODE BEGIN 0 */
// ALIGN_32BYTES (uint16_t adc_data[3]) __attribute__((section(".ARM.__at_0x30000000")));
/* USER CODE END 0 */
...
//  hadc2.Init.Oversampling.OversamplingStopReset = ADC_REGOVERSAMPLING_CONTINUED_MODE;
  ...
  */
  ...
  /* USER CODE BEGIN ADC2_Init 2 */
    ...
    // HAL_ADC_Start_DMA(&hadc2, (uint32_t *)&adc_data, 3);
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = KEY_UP_DOWN_Pin|KEY_LEFT_RIGHT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOC, KEY_UP_DOWN_Pin|KEY_LEFT_RIGHT_Pin);
...
// //  SCB_InvalidateDCache_by_Addr(&adc_data[ch], sizeof(uint16_t));
//   return (uint16_t)adc_data[ch];
// }
/* USER CODE END 1 */
