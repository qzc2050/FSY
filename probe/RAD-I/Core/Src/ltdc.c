...
void MX_LTDC_Init(void)
{
  ...
  hltdc.Init.AccumulatedHBP = LTDC_ACCUMULATED_HBP;
  hltdc.Init.AccumulatedVBP = LTDC_ACCUMULATED_VBP;
  hltdc.Init.AccumulatedActiveW = LTDC_ACCUMULATED_ACTIVE_W;
  hltdc.Init.AccumulatedActiveH = LTDC_ACCUMULATED_ACTIVE_H;
  hltdc.Init.TotalWidth = LTDC_TOTAL_WIDTH;
  hltdc.Init.TotalHeigh = LTDC_TOTAL_HEIGHT;
  hltdc.Init.Backcolor.Blue = 78;
  hltdc.Init.Backcolor.Green = 78;
  hltdc.Init.Backcolor.Red = 78;
  ...
  pLayerCfg.Backcolor.Blue = 78;
  pLayerCfg.Backcolor.Green = 78;
  pLayerCfg.Backcolor.Red = 78;
