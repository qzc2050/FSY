...
/* 内存管理参数 */
const uint32_t memtblsize[SRAMBANK] = { MEM1_ALLOC_TABLE_SIZE, MEM3_ALLOC_TABLE_SIZE,
                                        MEM4_ALLOC_TABLE_SIZE, MEM5_ALLOC_TABLE_SIZE, MEM6_ALLOC_TABLE_SIZE
                                      };                                                /* 内存表大小 */    // MEM2_ALLOC_TABLE_SIZE, 

const uint32_t memblksize[SRAMBANK] = { MEM1_BLOCK_SIZE, MEM3_BLOCK_SIZE,
                                        MEM4_BLOCK_SIZE, MEM5_BLOCK_SIZE, MEM6_BLOCK_SIZE
                                      };                                                /* 内存分块大小 */  // MEM2_BLOCK_SIZE, 

const uint32_t memsize[SRAMBANK] = { MEM1_MAX_SIZE, MEM3_MAX_SIZE,
...
struct _m_mallco_dev mallco_dev=
{
    ...
    mem1base, mem3base, mem4base, mem5base, mem6base,                          /* 内存池 */  // mem2base, 
    mem1mapbase, mem3mapbase, mem4mapbase, mem5mapbase, mem6mapbase,        /* 内存管理状态表 */  // mem2mapbase, 
    0, 0, 0, 0, 0,                                                                    /* 内存管理未就绪 */  // 0, 
};
